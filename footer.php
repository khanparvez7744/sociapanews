<?php include (dirname(__FILE__).'/inc/popup.php'); ?>
<footer class="bg-red">
  ...
  <div class="row py-sm-5 pt-3 px-2 px-sm-0">
    ...
    <div class="col-lg-4 col-md-8 connectWithUs">
      ...
      <div class="d-flex my-sm-4 my-3">
        ...
        <a href="<?php echo $setting['linkedin_link'] ?>" class="me-sm-2" target="_blank"><i class="fab fa-linkedin fa-2x text-light"></i></a>
...
<h6 class="Poppins-Bold">Subscribe Sociapa News letter</h6>
...
<p class="mt-3 fs-14" id="message"></p>
    ...
    <li class="fs-14 mt-2"><a href="/privacy-policy" class="text-white text-decoration-none">PRIVACY POLICY</a></li>
    <li class="fs-14 mt-2"><a href="/sitemap" class="text-white text-decoration-none">SITEMAP</a></li>
...
<div class="row">
  <div class="col-sm-6 py-sm-2 py-1 fs-14 d-none d-sm-block">
    <small>2021 © Sociapa News , All rights reserved.</small>
  </div>
