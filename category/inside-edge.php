...
<script>
  ...
  <meta name="title" content="Sociapa News | Insides">
  <meta name="keywords" content="Sociapa News | Insides">
  <meta name="description" content="Sociapa News | Insides">
  <meta name="author" content="Sociapa News | Insides">
  <title>Sociapa News | Insides</title>
...
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="nndMenubar">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link text-light text-capitalize" href="insides-edge">Insides</a>
              </li>
  ...
  <?php
     $data=0;
     $sql="SELECT * FROM category where category='Insides' and is_active=0";
     $result=$pdo->query($sql);
     $data=$result->fetch();
     if(empty($data)){
        $result=$pdo->query("SELECT * FROM subcategory where sub_category='Insides' and is_active=0");
        $data=$result->fetch();
     }
   ?>
  <!--<section>-->
...
<!-- !advertisment area -->
      ...
      <div class="col-lg-8 col-6 px-lg-5 px-0">
        ...
        <div class="row g-3">
          <?php $sql="SELECT * FROM news where (category='Insides' or sub_category='Insides') and is_active=0";
           $result=$pdo->query($sql);
          $data=$result->fetchAll();
          foreach ($data as $value) {
              $a = strip_tags( $value['heading']);
